                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl shadow-lg p-8 text-white">
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start">
                                    ...
                                    <p>Valid business registration (GSTIN required)</p>
                                </li>
                                <li className="flex items-start">
                                    <div className="mt-1 mr-3">•</div>
                                    <p>Minimum 1 year of business operations</p>
                                </li>
                                <li className="flex items-start">
                                    <div className="mt-1 mr-3">•</div>
                                    <p>Ability to handle daily orders</p>
                                </li>
                                <li className="flex items-start">
                                    <div className="mt-1 mr-3">•</div>
                                    <p>Own delivery capability or tie-up with delivery service</p>
                                </li>
                                <li className="flex items-start">
                                    <div className="mt-1 mr-3">•</div>
                                    <p>Commitment to quality and freshness</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-8">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <button
                                type="submit"
                                className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white py-4 rounded-xl font-bold text-lg hover:from-orange-600 hover:to-orange-700 transition-all duration-300 shadow-lg hover:shadow-xl"
                            >
                                Apply Now
                            </button>
                        </form>
